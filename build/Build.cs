...
class Build : NukeBuild
{
    ...
    Target Compile => _ => _
        ...
        .Executes(() =>
        {
            Logger.Info("Building Octopus.Caching v{0}", GitVersion.FullSemVer);
    ...
    Target CopyToLocalPackages => _ => _
        ...
        .Executes(() =>
        {
            ...
            CopyFileToDirectory(ArtifactsDirectory / $"Octopus.Caching.{GitVersion.FullSemVer}.nupkg", LocalPackagesDirectory, FileExistsPolicy.Overwrite);
        });
